// Pastikan AI Tools & Chatbot Berfungsi dengan Baik
...
const apiKey = "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";
        ...
        try {
            const response = await fetch("https://openrouter.ai/api/v1/chat/completions", {
                ...
                body: JSON.stringify({
                    ...
                    messages: [
                        { role: "system", content: "Anda adalah AI Trend Analyzer yang menganalisis tren pasar berdasarkan industri yang dimasukkan." },
                        { role: "user", content: `Apa tren terbaru dalam industri ${industry}?` }
                    ]
                })
            });
